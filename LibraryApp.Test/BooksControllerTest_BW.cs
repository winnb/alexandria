...
{
    public class BooksControllerTest_BW
    {
        [Fact]
        public void IndexUnitTest_BW()
        {
            //arrange
        ...
        public void DeleteTest_BW(string validGuid)
        {
            //arrange
            var mockRepo = new Mock<IBookService>();
            mockRepo.Setup(n => n.GetAll()).Returns(MockData.GetTestBookItems());
            ...
            //act
            var result = controller.Delete_BW(itemGuid, null);
