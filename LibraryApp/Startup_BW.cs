...
using AppDbContext_BW = LibraryApp.Data.AppDbContext_BW;

namespace LibraryApp
{
    public class Startup_BW
    {
        public Startup_BW(IConfiguration configuration)
        {
        ...
        {
            services.AddDbContext<AppDbContext_BW>(opt => opt.UseInMemoryDatabase("this-is-just-test"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            AppDbContext_BW context = scopeeee.ServiceProvider.GetRequiredService<AppDbContext_BW>();
            AddTestData(context);
        ...
        private void AddTestData(Data.AppDbContext_BW context)
        {

            var _books = new List<Book_BW>()
            {
               new Book_BW()
                {
